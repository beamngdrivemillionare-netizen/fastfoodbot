const tg = window.Telegram && window.Telegram.WebApp;
  ...
  // Buyurtma bekor qilinganda, "to'g'ridan skladdan" sotilgan mahsulotlar
  // (masalan, Kola, Pepsi kabi shishalar) ochilmagan holda qaytgan bo'lishi
  // mumkin. Retsept asosida tayyorlangan taomlar bu ro'yxatga kiritilmaydi,
  // chunki ular allaqachon tayyorlangan bo'lishi mumkin va qaytarilmaydi.
